...
//#include "Shapes.h"
#include <random>
#include "../../../Dropbox (Personal)/COP3503C/Lab6/Shapes.h"
using namespace std;
...
void TestOne()
{
	...
	shapes.push_back(new Square(1.1f));
	shapes.push_back(new Triangle);
	shapes.push_back(new Triangle(4.4f, 5.5f));
	shapes.push_back(new Circle);
	shapes.push_back(new Circle(6.6f));
...
void TestTwo()
{
	...
	shapes.push_back(new TriangularPyramid(1.1f, 2.2f, 3.3f));
	shapes.push_back(new Cylinder);
	shapes.push_back(new Cylinder(7.7f, 8.8f));
	shapes.push_back(new Sphere);
	shapes.push_back(new Sphere(9.9f));
